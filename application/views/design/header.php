            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="<?= site_url('components/grids');?>"><i class="fa fa-angle-right"></i> Grids</a></li>
                  <li><a href="<?= site_url('components/media');?>"><i class="fa fa-angle-right"></i> Media Css</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="charts.html">
